...
public class CommandCrazyMazeSetOnWin extends BukkitCommand {

	public CommandCrazyMazeSetOnWin() {
		super("onwin");
		
		setDescription("Sets the command that will be run after a game ends and a player wins. \"%winner%\" will be replaced with the winner's name, \"%winneruuid%\" with the winner's UUID");
		setUsage("/crazymaze set onwin <onwin command>");
	}
	...
	public void action(CommandInvokedEvent event) {
		...
		String cmdR = Arrays.stream(args).collect(Collectors.joining(" "));
