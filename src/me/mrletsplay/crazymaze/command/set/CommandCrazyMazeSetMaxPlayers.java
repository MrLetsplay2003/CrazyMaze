...
public class CommandCrazyMazeSetMaxPlayers extends BukkitCommand {

	public CommandCrazyMazeSetMaxPlayers() {
		super("maxplayers");
		
		setDescription("Sets the maximum amount of players that can join the arena");
		setUsage("/crazymaze set maxplayers <amount>");
	}
